...
type IpcChannel = "project:list" | "project:get-active" | "project:set-active" | "project:create" | "project:destroy" | "project:status" | "config:read-global" | "config:write-global" | "stage:run" | "stage:abort" | "stage:revert" | "session:send-message" | "session:event" | "costs:read" | "project:read-artifacts" | "dialog:open-directory" | "dialog:open-file" | "dialog:save-file" | "project:update" | "project:clone-repo" | "project:extract-archive" | "reporter:log" | "reporter:warn" | "reporter:error";
